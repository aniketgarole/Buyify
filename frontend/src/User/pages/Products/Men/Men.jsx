...
import { Box, Button, Checkbox, Flex, Heading, Image, Select, Text, Grid, Stack, Skeleton, ButtonGroup } from "@chakra-ui/react"
  ...
  return (
    ...
    <Box>
      ...
      <Flex mt={"-10px"}
        ...
        <Box display={{ base: "none", lg: "block" }} width="300px"
        //  border="1px solid #dadede"
        >
          <Sidebar
          brand={brand}
      ...
      <Flex pos={"fixed"} bottom="0" width="100%" display={{ base: "block", lg: "none" }}>
        <FiltersDrawer brand={brand}
          setBrand={setBrand}
          subcategory={subcategory}
          setsubCategory={setsubCategory}
          setPage={setPage} />
