...
const failedAdd = () => {
  ...
  return (
    <>
      ...
      <Box>
        <Text fontSize={"1.2rem"} fontWeight={"bold"} color="blackAlpha.900">
          {title}
        </Text>
      </Box>
      <Flex
      ...
      >
          ...
          <Box mt="30px" ml="10px">
            ...
            <Flex gap={3} mt="10px">
              ...
              <Text fontSize={"0.9rem"} fontWeight={"medium"}>
                84% positive ratings from 10K+ customers
              </Text>
            </Flex>
            <Flex gap={3} mt="10px">
              <Image
        ...
        <Box
          width={{ base: "90%", sm: "90%", md: "80%", lg: "60%" }}
          pr={"30px"}
          pl="30px"
        >
          <Divider />
          <Text mb={"20px"} mt="5px" color={"teal.500"}>
            Visit the {brand} Store
          </Text>
          <Divider />
          <Text mt={"5px"} fontWeight={"bold"} color={"red.500"}>
            Summer Sale Deal
          </Text>
          <Flex gap={2}>
          ...
          <Flex color={"gray.600"} gap={1}>
            <Text fontSize={"0.8rem"}>M.R.P.:</Text>
            <Text fontSize={"0.8rem"} decoration={"line-through"}>
              {originalPrice}
            </Text>
          </Flex>

          <Text mt={"10px"} fontSize={"sm"} fontWeight={"medium"}>
            Inclusive of all taxes
          </Text>
          <Text mb={"10px"} fontWeight={"medium"}>
            <b>EMI</b> starts at ₹{Math.floor(offerPrice / 10)} per month.
          </Text>
          ...
          >
            <Box align="center">
              ...
              <Text fontSize="12px" color={"#007185"} fontWeight={"medium"}>
                {" "}
                Free Delivery
              </Text>
            </Box>
          ...
          <Box mt="10px">
            <Text fontWeight={"bold"}>Highly rated by customers for</Text>
            <Flex gap={5} mt="10px">
              <Flex pr="5px" pl="5px" bgColor="blackAlpha.300" gap={1}>
                <TbThumbUp />
        ...
        <Box
          mt={{ lg: "-100px", base: 0 }}
          width={{ base: "90%", sm: "90%", md: "90%", lg: "20%" }}
          pr="10px"
        >
          <Divider />
          ...
          >
            ...
            <Text fontWeight={"bold"} color={"#007185"}>
              within 5 days
            </Text>

            <Text fontSize={"1.2rem"} fontWeight={"semibold"} color="#007652">
              In stock
            </Text>
            <Text mt="10px" fontWeight={"semibold"} fontSize={"0.9rem"}>
              Sold by SELLER
            </Text>
            <Text fontSize={"0.9rem"} color={"#007185"} fontWeight={"semibold"}>
              Delivered by Amazon
            </Text>
          ...
          <Box
            ...
            width="150px"
          >
            <Text align={"center"} fontSize={"0.9rem"}>
              Sell on Amazon
            </Text>
          </Box>
        </Box>
